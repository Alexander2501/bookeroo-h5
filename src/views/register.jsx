		...
		return (
			<div className="signin signup">
				<div className="container">
								...
								<div className="signin-form">
									<form action="signin.html">
										...
										<div className="form-group">
											...
											<input type="email" className="form-control" id="signin_form" placeholder="enter your email here" />
										</div>
										<div className="form-group">
											
											<input type="password" className="form-control" id="signin_form" placeholder="Password" />
										</div>
										<div className="form-group">
										
											<input type="password" className="form-control" id="signin_form" placeholder="Retype Password" />
										</div>
									</form>
								</div>
							</div>
						...
						<div className="row">
							<div className="col-sm-12">
								<div className="signin-footer">
									<button type="button" className="btn signin_btn" data-toggle="modal" data-target=".signin_modal">
										sign up
									</button>
									<p>
					...
					<div className="modal fade signin_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
													...
													<form action="signin.html">
														<div className="form-col">
															<div className="form-group">
																...
																<input type="text" className="form-control" id="signin_form" placeholder="UserName" />
															</div>
														</div>
